...
# Save the figure object in HTML format in the local drive
fig.write_html(r'C:\Users\jpavithr\OneDrive - Capgemini\Desktop\Automation Drive - Python training\Pandas\real python\Covid_statewise_chloropeth\Chloropeth Map - COVID-19 Cases in India.JPG.html')
